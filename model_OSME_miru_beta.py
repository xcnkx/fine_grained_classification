...
attention_s1 = osme_block(base_model.output, base_model.output_shape[3], name='attention_s1')
attention_s2 = osme_block(base_model.output, base_model.output_shape[3], name='attention_s2')

s_1 = osme_block(base_model.output, base_model.output_shape[3], name='s1')
s_2 = osme_block(base_model.output, base_model.output_shape[3], name='s2')


fc1 = Flatten()(s_1)
fc2 = Flatten()(s_2)

fc1 = Dense(512, name='fc1')(fc1)
fc2 = Dense(512, name='fc2')(fc2)

fc = concatenate([fc1,fc2]) #fc1 + fc2

x_1 = Add()([base_model.output, attention_s1])
x_2 = Add()([base_model.output, attention_s2])
...
output_2_1 = GlobalAveragePooling2D(name='output_2_1')(x_1)
output_2_2 = GlobalAveragePooling2D(name='output_2_2')(x_2)

output_2 = concatenate([output_2_1,output_2_2])
 
attention_branch = Dense(num_classes, activation='softmax', name='attention_branch')(fc)
...
checkpointer = ModelCheckpoint(filepath='/home/n-kamiya/models/model_without_MAMC/model_OSME_SE_miru_beta.best_loss.hdf5', verbose=1, save_best_only=True)
...
with open('/home/n-kamiya/models/model_without_MAMC/history_inceptv3_with_OSME_miru_beta{0:%d%m}-{0:%H%M%S}.json'.format(now), 'w') as f:
