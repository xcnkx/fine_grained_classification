...
# -*- coding: utf-8 -*-
"""
Created on Tue Oct 30 02:52:05 2018
...
base_model_vgg19 = VGG19(weights = "imagenet", include_top=False, input_tensor=input_tensor)

# change only the output layer 

top_model = Sequential()
top_model.add(GlobalAveragePooling2D(input_shape=base_model_vgg19.output_shape[1:]))
top_model.add(Dense(512,activation='relu'))
top_model.add(Dropout(0.5))
top_model.add(Dense(num_classes, activation='softmax'))

model_vgg19 = Model(input=base_model_vgg19.input, output=top_model(base_model_vgg19.output))
