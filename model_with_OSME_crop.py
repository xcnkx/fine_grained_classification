...
checkpointer = ModelCheckpoint(filepath='/home/n-kamiya/models/model_without_MAMC/model_osme_inceptv3_cropped_alpha.best_loss.hdf5', verbose=1, save_best_only=True)
...
plt.savefig("/home/n-kamiya/models/model_without_MAMC/history_inceptv3_with_OSME_cropped_alpha{0:%d%m}-{0:%H%M%S}.png".format(now))
plt.show()
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig("/home/n-kamiya/models/model_without_MAMC/loss_inceptv3_with_OSME_cropped_alpha{0:%d%m}-{0:%H%M%S}.png".format(now))
plt.show()
