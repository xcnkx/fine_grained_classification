...
# -*- coding: utf-8 -*-
"""
Created on Wed Oct 31 06:11:16 2018
...
checkpointer = ModelCheckpoint(filepath='/home/n-kamiya/models/model_without_MAMC/model_osme_resnet50.best_loss.hdf5', verbose=1, save_best_only=True)
...
plt.savefig("/home/n-kamiya/models/model_without_MAMC/history_osme_resnet50{0:%d%m}-{0:%H%M%S}.png".format(now))
#plt.show()
...
plt.xlabel('epoch')
plt.legend(['train', 'test'], loc='upper left')
plt.savefig("/home/n-kamiya/models/model_without_MAMC/loss_osme_resnet50{0:%d%m}-{0:%H%M%S}.png".format(now))
#plt.show()
